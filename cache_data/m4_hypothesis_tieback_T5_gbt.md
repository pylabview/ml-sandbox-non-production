...
- **PDP peak breadth:** 1  (drop to tail: 0.3217; drop to b=1: 0.0000)
- **ICE peaks:** median=1 (IQR 1–1), share in [1,2,3] = 100.0%; post-peak ↓ share≥60% = 100.0%
- **Evidence:** moderate

## H2. PaceSlack_T helps then plateaus
- **Avg early slope:** -0.264237   |   **Avg late slope:** -0.015609   |   **Turning slack (≈ plateau):** 0.000
- **Evidence:** moderate

## H3. Interaction — fast-focused vs slow-scatter
- **Fast-focused (low breadth, high slack):** p=0.23283
- **Slow-scatter (high breadth, low slack):** p=0.10331
- **Slack lift @low breadth:**  Δ=-0.36271   |   **@high breadth:**  Δ=-0.00343   |   **Synergy (low−high):** -0.35928
- **High-slack gap (low breadth − high breadth):** +0.13294
- **Evidence:** moderate
